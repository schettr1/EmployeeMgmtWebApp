...
<body>
	<%
		...
		System.out.println(" adminLogin.jsp: LoggedInUser = " + UP);
		String[] UPs = UP.split(" ");
		...
		System.out.println(" After update: adminLogin.jsp: LoggedInUser = " + UP);

		consultant = consultantservice.getConsultantById(updatedLogin.getU_id());

		System.out.println("adminLogin.jsp: updatedLogin.getPassword() : " + updatedLogin.getPassword());
		System.out.println("adminLogin.jsp: consultant fileName : " + consultant.getFileName());
	%>
	...
	<div class="container wrapper">
		...
		<div style="float: left">
			<form method="GET" action="edit.jsp"
				style="display: inline-block; float: left; padding: 0 20px">
			...
			<form method="get" action="createPayment.jsp"
				style="display: inline-block; margin-left: 70px">
				<input class="btn btn-default" type="text"
					style="visibility: hidden; width: 10px" value="<%=UP%>"
					name="payment"> <input class="btn btn-info" type="submit"
					style="width: 100px" value="Payment">
			</form>
			<form method="get" action="listAll.jsp"
				style="display: inline-block; margin-left: 50px">
				<input class="btn btn-default" type="text"
					style="visibility: hidden; width: 10px" value="<%=UP%>"
					name="listAll"> <input class="btn btn-info" type="submit"
					style="width: 100px" value="List All">
			</form>
