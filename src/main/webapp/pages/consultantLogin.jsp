<html>
<head>
<title>consultant LogIn Page</title>
<script
...
<body>
	<%
		// Since the password has been changed, we can only use the username from session attribute, and update the session object
		String UP = session.getAttribute("LoggedInUser").toString();
		System.out.println(" consultantLogin.jsp: LoggedInUser = " + UP);
		...
		System.out.println(" After update: consultantLogin.jsp: LoggedInUser = " + UP);
		
		consultant = consultantservice.getConsultantById(updatedLogin.getU_id());


		System.out.println("consultantLogin.jsp: updatedLogin.getPassword() : " + updatedLogin.getPassword());
		System.out.println("consultantLogin.jsp: consultant fileName : " + consultant.getFileName());
	%>
